    ...
    if($rows == 0)
    {
        ?>
         <h3 class="text-center">
            ...
            There are no pictures to show at this point<br> Want to add your own picture? <a href="add.php"></a> 
        <h3>
        <?php
    }else{
        ?>
                ...
                <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p class="text-center">
                             ...
                             class="popup-rate btn btn-primary btn-block" role="button">Rate picture</a>
                            </p>
                             <?php }else{
                                 echo "You need to be logged in to rate a picture";
                             }?>
                        </div>
                </div>
            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="popupimage-modal">
  <div class="modal-dialog  modal-lg" role="document">
    ...
    </div><!-- /.start modal-content -->
  </div><!-- /.start modal-dialog -->
</div><!-- /.start modal -->
  ...
  <div class="modal-dialog  modal-lg" role="document">
    ...
    <div class="modal-header">
      ...
      <form method="POST">
          ...
          <!--The different rating alternatives-->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Rate picture</button>
            </div>
        </form>
      </div>
